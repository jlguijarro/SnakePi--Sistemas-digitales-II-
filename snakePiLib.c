...
void InicializaSnakePi(tipo_snakePi *p_snakePi) {
	...
	p_snakePi ->tmr_refresco = tmr_new(timer_general);
...
void InicializaJuego(fsm_t* this) {
	...
	p_snakePi -> p_pantalla = &(led_display.pantalla);
	...
	tmr_startms(p_snakePi ->tmr_refresco, TIMEOUT_ACTUALIZA_JUEGO);
...
void FinalJuego (fsm_t* this) {
	//tipo_snakePi* p_snakePi = (tipo_snakePi*)(this->user_data);
